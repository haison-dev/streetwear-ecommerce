        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              {product.salePrice ? (
                <>
                  <span className="font-body text-2xl font-semibold">{product.salePrice.toLocaleString("vi-VN")} đ</span>
                  <span className="font-body text-lg text-muted-foreground line-through">
                    {product.price.toLocaleString("vi-VN")} đ
                  </span>
                </>
              ) : (
                <span className="font-body text-2xl font-semibold">{product.price.toLocaleString("vi-VN")} đ</span>
              )}
            </div>
